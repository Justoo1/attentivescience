...
import { eventFormSchema } from "@/lib/validiator";
...
const EventForm = ({createdBy, type, event, eventId }: EventFormProps) => {
    ...
    if(type === "Update"){
        ...
        try {
            ...
            if(updatedEvent){
                ...
                window.location.reload();
                // router.push(`events`)
                // const url = `/events/${updatedEvent._id}`;
                // window.open(url, '_blank');
            }
        } catch (error) {
            console.log(error)
        ...
        <div className="flex flex-col gap-5 md:flex-row">
            {/* <FormField
                ...
                render={({ field }) => (
                    ...
                    <FormControl>
                        <div className="flex-center h-[54px] w-full overflow-hidden rounded-full bg-gray-50 px-4 py-2">
                            <Image src="/assets/icons/dollar.svg" height={24} width={24} alt="dollar" className="filter-grey" />
                ...
                render={({ field }) => (
                    ...
                    <FormControl>
                        <div className="flex items-center">
                            <label htmlFor="isFree" className="whitespace-nowrap pr-3 leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Published</label>
            ...
            {/* <FormField
                ...
                render={({ field }) => (
                    ...
                    <FormControl>
                        <div className="flex-center h-[54px] w-full overflow-hidden rounded-full bg-gray-50 px-4 py-2">
                            <Image src="/assets/icons/link.svg" height={24} width={24} alt="link" />
