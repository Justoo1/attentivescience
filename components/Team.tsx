...
const Team = ({ team }: {team: teamProps}) => {
  return (
    <Link href={`/team#${team.id}`}>
      <div className="bg-grey-600/5 w-64 h-72 lg:w-[360px] lg:h-96 lg:gap-4 2xl:w-[488px] 2xl:h-[498px] flex flex-col gap-3 2xl:gap-8 justify-center items-center rounded-md hover:scale-110 hover:shadow-2xl hover:shadow-red-100 transform transition-all">
